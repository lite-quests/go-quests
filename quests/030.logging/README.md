...
Imagine you get a vague error log in production that just says "failed to process". You have no idea *which* user failed, *which* request it was part of, or *what* they were searching for. Structured logging solves this.
